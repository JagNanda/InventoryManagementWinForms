...
namespace InventoryManagement {
    ...
    public partial class Inventory_ManagementDataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK_Departments_Item;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK_Departments_Item = this.Relations["FK_Departments_Item"];
        }
        ...
        private void InitClass() {
            ...
            fkc = new global::System.Data.ForeignKeyConstraint("FK_Departments_Item", new global::System.Data.DataColumn[] {
                        this.tableDepartments.Department_IdColumn}, new global::System.Data.DataColumn[] {
                        this.tableItem.Department_IdColumn});
            this.tableItem.Constraints.Add(fkc);
            fkc.AcceptRejectRule = global::System.Data.AcceptRejectRule.None;
            fkc.DeleteRule = global::System.Data.Rule.Cascade;
            fkc.UpdateRule = global::System.Data.Rule.Cascade;
            this.relationFK_Departments_Item = new global::System.Data.DataRelation("FK_Departments_Item", new global::System.Data.DataColumn[] {
                        this.tableDepartments.Department_IdColumn}, new global::System.Data.DataColumn[] {
                        this.tableItem.Department_IdColumn}, false);
            this.Relations.Add(this.relationFK_Departments_Item);
        }
        ...
        public partial class DepartmentsDataTable : global::System.Data.TypedTableBase<DepartmentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public DepartmentsRow AddDepartmentsRow(string Department_Name, string Department_Description) {
            ...
            private void InitClass() {
                ...
                this.columnDepartment_Description.MaxLength = 50;
            }
        ...
        public partial class ItemDataTable : global::System.Data.TypedTableBase<ItemRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ItemRow AddItemRow(string Item_Name, int Item_Quantity, DepartmentsRow parentDepartmentsRowByFK_Departments_Item) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        Item_Quantity,
                        null};
                if ((parentDepartmentsRowByFK_Departments_Item != null)) {
                    columnValuesArray[3] = parentDepartmentsRowByFK_Departments_Item[0];
                }
        ...
        public partial class DepartmentsRow : global::System.Data.DataRow {
            ...
            public string Department_Description {
                get {
                    return ((string)(this[this.tableDepartments.Department_DescriptionColumn]));
                }
                set {
                    this[this.tableDepartments.Department_DescriptionColumn] = value;
                }
            }
            ...
            public ItemRow[] GetItemRows() {
                if ((this.Table.ChildRelations["FK_Departments_Item"] == null)) {
                    return new ItemRow[0];
                }
                else {
                    return ((ItemRow[])(base.GetChildRows(this.Table.ChildRelations["FK_Departments_Item"])));
                }
            }
        }
        ...
        public partial class ItemRow : global::System.Data.DataRow {
            ...
            public int Department_Id {
                get {
                    return ((int)(this[this.tableItem.Department_IdColumn]));
                }
                set {
                    this[this.tableItem.Department_IdColumn] = value;
                }
            }
            ...
            public DepartmentsRow DepartmentsRow {
                get {
                    return ((DepartmentsRow)(this.GetParentRow(this.Table.ParentRelations["FK_Departments_Item"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_Departments_Item"]);
                }
            }
        }
...
namespace InventoryManagement.Inventory_ManagementDataSetTableAdapters {
    ...
    public partial class DepartmentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Departments] WHERE (([Department_Id] = @Original_Department_Id" +
                ") AND ([Department_Name] = @Original_Department_Name) AND ([Department_Descripti" +
                "on] = @Original_Department_Description))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Departments] ([Department_Name], [Department_Description]) VAL" +
                "UES (@Department_Name, @Department_Description);\r\nSELECT Department_Id, Departme" +
                "nt_Name, Department_Description FROM Departments WHERE (Department_Id = SCOPE_ID" +
                "ENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Departments] SET [Department_Name] = @Department_Name, [Department_Description] = @Department_Description WHERE (([Department_Id] = @Original_Department_Id) AND ([Department_Name] = @Original_Department_Name) AND ([Department_Description] = @Original_Department_Description));
SELECT Department_Id, Department_Name, Department_Description FROM Departments WHERE (Department_Id = @Department_Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Department_Id, Department_Name, Department_Description FROM dbo.Department" +
                "s";
        ...
        public virtual int Fill(Inventory_ManagementDataSet.DepartmentsDataTable dataTable) {
        ...
        public virtual Inventory_ManagementDataSet.DepartmentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Inventory_ManagementDataSet.DepartmentsDataTable dataTable = new Inventory_ManagementDataSet.DepartmentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Inventory_ManagementDataSet.DepartmentsDataTable dataTable) {
    ...
    public partial class ItemTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Item] WHERE (([Id] = @Original_Id) AND ([Item_Name] = @Origina" +
                "l_Item_Name) AND ([Item_Quantity] = @Original_Item_Quantity) AND ([Department_Id" +
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Item] ([Item_Name], [Item_Quantity], [Department_Id]) VALUES (" +
                "@Item_Name, @Item_Quantity, @Department_Id);\r\nSELECT Id, Item_Name, Item_Quantit" +
                "y, Department_Id FROM Item WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Item] SET [Item_Name] = @Item_Name, [Item_Quantity] = @Item_Quantity, [Department_Id] = @Department_Id WHERE (([Id] = @Original_Id) AND ([Item_Name] = @Original_Item_Name) AND ([Item_Quantity] = @Original_Item_Quantity) AND ([Department_Id] = @Original_Department_Id));
SELECT Id, Item_Name, Item_Quantity, Department_Id FROM Item WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, Item_Name, Item_Quantity, Department_Id FROM dbo.Item";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(Inventory_ManagementDataSet.ItemDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual Inventory_ManagementDataSet.ItemDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Inventory_ManagementDataSet.ItemDataTable dataTable = new Inventory_ManagementDataSet.ItemDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Inventory_ManagementDataSet.ItemDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, string Original_Item_Name, int Original_Item_Quantity, int Original_Department_Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string Item_Name, int Item_Quantity, int Department_Id) {
            if ((Item_Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Item_Name, int Item_Quantity, int Department_Id, int Original_Id, string Original_Item_Name, int Original_Item_Quantity, int Original_Department_Id, int Id) {
            if ((Item_Name == null)) {
                throw new global::System.ArgumentNullException("Item_Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_Item_Quantity));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Item_Name, int Item_Quantity, int Department_Id, int Original_Id, string Original_Item_Name, int Original_Item_Quantity, int Original_Department_Id) {
            return this.Update(Item_Name, Item_Quantity, Department_Id, Original_Id, Original_Item_Name, Original_Item_Quantity, Original_Department_Id, Original_Id);
        }
    }
